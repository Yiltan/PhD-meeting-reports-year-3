...
def plot_small():
    ...
    # Bcast
    file_name = "bcast-p8-t32-n40.out"
    ...
    # Pbcast
    file_name = "pbcast-p8-t32-n40.out"
    size, mean, std = read_data(file_name)
    size = size[:11]
    mean = mean[:11]
    std = std[:11]
    ...
    # Pbcast
    file_name = "pbcast-parrived-p8-t32-n40.out"
    size, mean, std = read_data(file_name)
    size = size[:11]
    mean = mean[:11]
    std = std[:11]
    ...
    plt.savefig("small_8.pdf", dpi=1000, bbox_inches='tight')
    plt.clf()
...
def plot_med():
    ...
    plt.savefig("med_8.pdf", dpi=1000, bbox_inches='tight')
    plt.clf()
...
def plot_large():
    ...
    plt.savefig("large_8.pdf", dpi=1000, bbox_inches='tight')
    plt.clf()
