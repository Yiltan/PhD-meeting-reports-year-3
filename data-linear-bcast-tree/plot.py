...
def plot_small():
    ...
    # Bcast
    file_name = "bcast-p16-t32-n40.out"
    ...
    # Pbcast
    file_name = "pbcast-p16-t32-n40.out"
    size, mean, std = read_data(file_name)
    size = size[:11]
    mean = mean[:11]
    std = std[:11]
    ...
    # Pbcast
    file_name = "pbcast-parrived-p16-t32-n40.out"
    size, mean, std = read_data(file_name)
    size = size[:11]
    mean = mean[:11]
    std = std[:11]
    ...
    plt.savefig("small.pdf", dpi=1000, bbox_inches='tight')
    plt.clf()
...
def plot_med():
    ...
    plt.savefig("med.pdf", dpi=1000, bbox_inches='tight')
    plt.clf()
...
def plot_large():
    ...
    plt.savefig("large.pdf", dpi=1000, bbox_inches='tight')
    plt.clf()
